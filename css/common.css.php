...
hr {
	color: <?= $GLOBALS['cfg']['MainText']; ?>;
	background-color: <?= $GLOBALS['cfg']['MainText']; ?>;
	border: 0;
	height: 1px;
}
...
fieldset, .preview_sql {
	...
	padding: 0.5em;
	background: #eee;
	text-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px #fff inset;
	-moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px #fff inset;
	-webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px #fff inset;
	box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px #fff inset;
}
...
fieldset legend {
	...
	-moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px 15px #bbb;
	-webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px 15px #bbb;
	box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px 15px #bbb;
	max-width: 100%;
}
...
select[multiple] {
	<?= $theme->getCssGradient('ffffff', 'f2f2f2'); ?>
}
...
table tr.marked:not(.nomarker) {
	<?= $theme->getCssGradient('ced6df', 'b6c6d7'); ?>
...
/* default tab styles */
.tabactive {
	background: <?= $GLOBALS['cfg']['NaviPointerBackground'];?> !important;
}
...
.popupContent {
	...
	margin: 0;
	padding: 3px;
	-moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 3px #666;
	-webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 3px #666;
...
.group {
	border: <?= $GLOBALS['cgf']['GroupBorder'];?>px solid <?= $GLOBALS['cgf']['GroupBorderColor'];?>;
	background: <?= $GLOBALS['cgf']['GroupBackground'];?>;
	margin-bottom: 1em;
	padding-bottom: 1em;
}

.group h2 {
	background-color: <?= $GLOBALS['cgf']['GroupHeaderBackground'];?>;
	padding: .1em .3em;
	margin-top: 0;
	color: #fff;
	font-size: 1.6em;
...
/**
 ...
 .ajax_notification {
	...
	left: 0;
	right: 0;
	background-image: url(<?= $theme->getImgPath('ajax_clock_small.gif');?>);
	background-repeat: no-repeat;
...
.cEdit .edit_box_posting {
	background: #FFF url(<?= $theme->getImgPath('ajax_clock_small.gif');?>) no-repeat right center;
	padding-<?= $right; ?>: 1.5em;
}

.cEdit .edit_area_loading {
	background: #FFF url(<?= $theme->getImgPath('ajax_clock_small.gif');?>) no-repeat center;
	height: 10em;
}
...
.saving_edited_data {
	background: url(<?= $theme->getImgPath('ajax_clock_small.gif');?>) no-repeat left;
	padding-left: 20px;
}
...
.pma_sql_import_status {
	...
	-webkit-border-radius: 4px;
	border-radius: 4px;
	-moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 5px #ccc;
	-webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 5px #ccc;
...
.pma_drop_result h2 {
	...
	-moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 15px #999 inset;
	-webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 15px #999 inset;
	box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 15px #999 inset;
}
